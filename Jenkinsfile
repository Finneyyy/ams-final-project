    ...
    stages {
        ...
        stage('Deploy main playbook') {
            steps {
                ...
                ansiblePlaybook credentialsId: '/home/ubuntu/MasterKeys', disableHostKeyChecking: true, installation: 'ansible-config', inventory: 'inventory.yaml', playbook: 'playbook.yaml'
            }
        }
    }
}
